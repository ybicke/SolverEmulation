...
class AFNO1D(nn.Module):
    ...
    def __init__(self, 
        ...
        self.zero_freq_indices = zero_freq_indices  # New parameter
    ...
    def forward(self, x):
        ...
        # Zero out specified frequency indices
        if self.zero_freq_indices is not None:
            x[:, self.zero_freq_indices, :] = 0       
        ...
        # here the blockwhise spatial mixing/processing happens somehow

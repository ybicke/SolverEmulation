...
def get_model(model_name, mean2d, var2d, mean3d, var3d, is_test):
    ...
    elif model_name == 'afno_easyConcat_percentile':
        from column_files.afno_column_concatEasy_percentile import AFNONet
        model = AFNONet(
            num_cells=args.num_cells,
            patch_size=args.patch_size,
            embed_dim=args.vit_hidden_dim,
...
def test_model(model, test_set):
    ...
    # **Reset collected magnitudes before inference**
    model.collected_magnitudes = []
    ...
    if os.path.exists(file_path):
        ...
        print("Loaded magnitudes from saved file.")
        ...
        for i, data in enumerate(test_set):
            ...
            if total_samples % 100 == 99:
                print(f'collected {total_samples + 1} samples')
        ...
        # **Access collected magnitudes after inference and sort**

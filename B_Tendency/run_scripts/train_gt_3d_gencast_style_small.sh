...
# run script
cd $myfolder
echo "Graph Transformer GenCast-Style (Small) training started!"

# Run the training script with reduced parameters for ~5M total params
python train_tendency.py \
    ...
    --save /mydata/deepcloud/yves/results-new/gt_gencast_small_512_l2_triangle39_k2 \
    --percent 1.0 \
    --num-workers 4 \
    --prefetch-factor 2 \
    --num-cells 81920 \

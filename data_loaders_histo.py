...
class IconColumnIterableDataset(IterableDataset):
    def __init__(self, filenames, cache_dir=None, shuffle=False, subsample=None, dtype=torch.float32):
    ...
    def read_file(self, filename):
        ...
        if self.cache_dir is not None:
            local_file = os.path.join(self.cache_dir, os.path.basename(filename))

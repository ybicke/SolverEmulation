...
PLOT_NAME = "GNN_1D_2D_3D"  # Change this for each plot scenario
SUBFOLDER = "MAE_Tendency"  # Options: "MAE", "true_vs_predicted", or any custom folder name
...
def add_subplot_mae(fig, height_vals, mae_data_list, subplot_pos, models_names, 
    ...
    colors = ['blue', 'blue', 'green', 'purple', 'orange', 'brown', 'pink']

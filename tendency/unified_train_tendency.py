...
from unified_tendency_data_loader import UnifiedTendencyDataset
...
def interpolate_w_to_full_levels_tensor(w):
    """Linear interpolation for vertical wind from half to full levels"""
    if args.mode == '1d':
        ...
        from data_utils import interpolate_w_to_full_levels
        w_full = interpolate_w_to_full_levels(w)
...
def create_data_loader(input_files, output_files, shuffle=False, num_workers=None):
    ...
    dataset = UnifiedTendencyDataset(

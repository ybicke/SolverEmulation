...
source /mydata/deepcloud/yves/SolverEmulation/tendency/tendency_3d/setup.sh
...
python train_models_3d_tendency.py \
    ...
    --save /mydata/deepcloud/yves/results-temp/graph_transformer_3d_64_l4_k2_drop03_notSimplified\
    --percent 1 \
    --subsample 1 \
    --num-workers 8 \
    --prefetch-factor 4 \

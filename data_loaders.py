...
# filenames = [
#     '/mydata/deepcloud/salman/dataset/h5_data_all_chuncked/ml_ecrad_ape_R2B05_myrunscript_1year_183min_atm_3d_DOM01_ml_0001_lonlat_time_12198.0.h5',
#     '/mydata/deepcloud/salman/dataset/h5_data_all_chuncked/ml_ecrad_ape_R2B05_myrunscript_1year_183min_atm_3d_DOM01_ml_0001_lonlat_time_14375.7001953125.h5'
# ]

# ds = IconColumnIterableDataset(filenames, cache_dir='/tmp')

# dl = DataLoader(ds, batch_size=32, num_workers=32)

# for x3, x2, y in dl:
#     print(x3.shape, x2.shape, y.shape)
#     print('-'*100)

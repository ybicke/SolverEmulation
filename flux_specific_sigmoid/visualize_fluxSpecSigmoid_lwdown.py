...
def main():
    ...
    output_dir = '/mydata/deepcloud/yves/results_git/data_histograms/sigmoid_plotting_lwDown/'
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(os.path.join(output_dir, 'composite_sigmoid_plot_clamp100.png'))
    plt.show()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(os.path.join(output_dir, 'composite_sigmoid_cdf_plot_clamp100.png'))
    plt.show()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(os.path.join(output_dir, 'amplitude_normalized_sigmoid_clamp100.png'))
    plt.show()
